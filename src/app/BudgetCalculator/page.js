...
const BudgetCalculator = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-transaprent text-white p-6">
      ...
      <div className="w-full max-w-4xl my-auto">
        <h1 className="text-4xl font-bold mb-2 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Budget Calculator</h1>
                    ...
                    >
                      <td className="py-3 px-4 flex items-center">
                        <span 
                          ...
                          style={{ backgroundColor: COLORS[CATEGORIES.indexOf(item.category) % COLORS.length] }}
                        ></span>
                        {item.category}
                      </td>
