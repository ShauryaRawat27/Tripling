...
const destinations = [
  {
    ...
    places: '05 Places',
    rating: 4.7,
    image: '/images/california.jpg', // Updated path
  },
  {
    id: 2,
    name: 'All Inclusive',
    places: '16 Places',
    rating: 4.7,
    image: '/images/all-inclusive.jpg', // Updated path
  },
  {
    id: 3,
    name: 'Thailand',
    places: '10 Places',
    rating: 4.7,
    image: '/images/thailand.jpg', // Updated path
  },
  {
    id: 4,
    name: 'Tokyo',
    places: '08 Places',
    rating: 4.7,
    image: '/images/tokyo.jpg', // Updated path
  }
];  
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-3">
            <img 
              src="/images/hot-air-balloon.jpg" // Updated path
              alt="Hot Air Balloon" 
              className="w-12 h-12"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {destinations.map((destination) => (
            <div key={destination.id} className="group cursor-pointer bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
              <h3 className="font-extrabold text-xl mb-2 text-center text-black">
  {destination.name}
</h3>
                <div className="flex items-center justify-center gap-2 mb-3">
                  <svg 
                    className="w-5 h-5 text-black stroke-2" 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
